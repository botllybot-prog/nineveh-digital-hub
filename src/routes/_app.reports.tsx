      ...
      <div className="p-6 space-y-6">
              ...
              <AreaChart data={monthlyCompletion}>
                <defs>
                  <linearGradient id="areaFill" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="oklch(0.72 0.13 75)" stopOpacity={0.6} />
        ...
        <div className="rounded-xl bg-card border border-border shadow-card overflow-hidden">
          <div className="px-5 py-4 border-b border-border">
            <h3 className="font-bold">التقارير الجاهزة</h3>
          </div>
          <div className="divide-y divide-border">
            {reports.map((r) => (
              <div key={r.title} className="px-5 py-4 flex items-center gap-4 hover:bg-secondary/40 transition">
                ...
                <button className="h-9 px-4 rounded-lg bg-gradient-primary text-primary-foreground text-xs font-semibold flex items-center gap-2 shadow-elegant">
